...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-#i4i^4#r%5sl$o)c0z4vje#dp^%nj2-!j6+2__z6l1xd)nz&_e')
...
# Chatbot settings
CHATBOT_DEBUG = os.environ.get('CHATBOT_DEBUG', 'True') == 'True'
